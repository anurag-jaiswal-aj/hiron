...
def test_alembic_migration_upgrade_and_downgrade_smoke() -> None:
    ...
    try:
        ...
        pytest.skip("PostgreSQL test database connection not available; skipping live migration smoke test.")
        return
    ...
    try:
        ...
        assert "tenants" not in tables_after_downgrade, "tenants table must not exist after downgrade base"
