...
class Settings(BaseSettings):
    ...
    environment: Literal["development", "staging", "production"] = Field(
        default="development", description="Application deployment environment"
    )
    ...
    app_secret_key: str = Field(
        default="your_app_secret_key_here", description="Application secret key for security"
    )
    ...
    jwt_private_key_path: str = Field(default="keys/jwt_private.pem", description="Path to RSA private key")
    jwt_public_key_path: str = Field(default="keys/jwt_public.pem", description="Path to RSA public key")
    ...
    postgres_password: str = Field(default="your_postgres_password_here", description="PostgreSQL password")
