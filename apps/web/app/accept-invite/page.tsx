...
function AcceptInviteForm(): React.ReactElement {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    if (!token) {
      setError(
        "This invitation link is invalid or incomplete. Please ask your administrator to send you a new invitation.",
      );
      return;
    }
  ...
  if (!token && !isSuccess) {
    return (
      <div style={{ textAlign: "center" }}>
        ...
        >
          <p style={{ margin: "0 0 0.5rem", fontWeight: 600 }}>Invalid Invitation</p>
          <p style={{ margin: 0, color: "#FDE68A" }}>
            This invitation link is invalid or incomplete. Please ask your administrator to send you
            a new invitation.
          </p>
        </div>
        <Link
  ...
  if (isSuccess) {
    return (
      <div style={{ textAlign: "center" }}>
        ...
        >
          <p style={{ margin: "0 0 0.5rem", fontWeight: 600 }}>Invitation Accepted</p>
  ...
  return (
    ...
    >
      <p style={{ fontSize: "0.875rem", color: "var(--text-secondary)", margin: 0 }}>
        Set your password to activate your Hiron account.
      </p>
